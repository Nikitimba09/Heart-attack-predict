...
Label(Icon_window, text="cp - chest pain type (0 = typical angina, 1= atypical angina, 2 = non-anginal pain, "
                        "3 = asymptomatic)", font="arial 11").place(x=20, y=160)
Label(Icon_window, text="trestbps - resting blood pressure (in mm Hg on admission to the hospital)", font="arial "
                                                                                                          "11").place(
    x=20, y=190)
...
Label(Icon_window, text="fbs - fasting blood sugar > 120 mg/dl (1 = true; 0 = false)", font="arial 11").place(x=20,
                                                                                                              y=250)
Label(Icon_window, text="restecg - resting electrocardiographic results (0 = normal; 1 = having ST-T; 2 = "
                        "hypertrophy)",
